const resolutions = [
	{
		GitHub: [
			...
			{
				name: "Repository Cover",
				description: "The Cover image of the Repository",
				width: 1280,
				height: 640,
			}
		]
	},
	{
		Twitter: [
			{
				name: "Timeline Photo",
				description: "An image that you would post in your Timeline",
				width: 1200,
				height: 675,
			},
			{
	...
	},
	{
		Hashnode: [
			...
			{
				name: "Blog Cover",
				description: "The Cover image of Blog page",
				width: 1600,
				height: 480,
			},
			{
			...
			},
			{
				...
				description: "Used when your Blog is shared on Twitter, Facebook, etc",
				width: 800,
				height: 420,
			},
		],
