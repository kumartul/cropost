const Footer = () => {
	return (
		<div>
			<footer className="bg-white shadow-lg mt-24 p-4 flex flex-col space-y-2 absolute bottom-0 right-0 left-0 md:lg:flex-row md:lg:space-y-0 items-center justify-between dark:bg-[#1a1a1a]">
